...
import { OrderResponse, Product } from '.';
...
export type ProductsActionTypes = Init | IsLoading | StoreCategory | StoreProducts | AddToCart | UpdateCurrentPage | IsModalActive | OrderStatus;
